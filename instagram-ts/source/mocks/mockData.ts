...
export const mockPosts: Post[] = [
  {
    ...
    like_count: 245,
    comment_count: 12,
    taken_at: Date.now() - 60000 * 60 * 2, // 2 hours ago
    media_type: 1, // Image
  },
  {
    id: "post2",
    ...
    like_count: 89,
    comment_count: 5,
    taken_at: Date.now() - 60000 * 60 * 4, // 4 hours ago
    media_type: 1, // Image
  },
  {
    id: "post3",
    ...
    like_count: 156,
    comment_count: 8,
    taken_at: Date.now() - 60000 * 60 * 6, // 6 hours ago
    media_type: 1, // Image
  },
];
...
export const mockThreads: Thread[] = [
  ...
  },
  {
    ...
    users: [mockUsers[2]!],
    unread: false,
    lastActivity: new Date(Date.now() - 60000 * 120), // 2 hours ago
    lastMessage: {
      id: "msg6",
  ...
  },
  {
    ...
    users: [mockUsers[3]!],
    unread: true,
    lastActivity: new Date(Date.now() - 60000 * 30), // 30 minutes ago
    lastMessage: {
      id: "msg7",
...
export function generateMessage(
  ...
  return {
    id,
    timestamp: new Date(Date.now() - 60000 * minutesAgo),
    userId,
    username,
    isOutgoing,
    threadId,
...
export function generateThread(
  ...
  return {
    ...
    users,
    unread,
    lastActivity: new Date(Date.now() - 60000 * 60 * hoursAgo),
    lastMessage,
  };
}
